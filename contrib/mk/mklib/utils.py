...
These are generic routines that are used within mklib or are deemed to
be super useful for `Makefile.py` authors.
"""

__all__ = ["paths_from_path_patterns"]
...
log  = logging.getLogger("mk.utils")
